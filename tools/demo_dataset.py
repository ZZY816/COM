...
def main():
    ...
    # )
    demo_dataset = WaymoDataset(dataset_cfg=cfg.DATA_CONFIG, class_names=cfg.CLASS_NAMES, training=True,
    ...
    for idx, data_dict in enumerate(demo_dataset):
        ...
        # exit()
        gt_box = data_dict['gt_boxes'][:, :, :-1].squeeze(0)

        V.draw_scenes(
            points=data_dict['points'][:, 1:], gt_boxes=gt_box
        )
